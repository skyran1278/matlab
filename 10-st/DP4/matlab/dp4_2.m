...
design_base_shear_z = base_shaer_z(base_shaer_z_diff2 > 1);

figure;
plot(period, base_shaer_z, [0 2.5], [design_base_shear_z(1) design_base_shear_z(1)], 'k--', [0 2.5], [base_shaer_z(end) base_shaer_z(end)], 'k--', [0.25 0.25], [base_shaer_z(end), design_base_shear_z(1)], ':');
text(1, design_base_shear_z(1) - 1000, ['static LRFD design base shear = ' num2str(design_base_shear_z(1)) ' kN']);
text(1, base_shaer_z(end) - 500, ['ultimate strength = ' num2str(base_shaer_z(end)) ' kN']);
text(0.3, (base_shaer_z(end) + design_base_shear_z(1)) / 2 + 1000, ['\Omega_0 = ' num2str(base_shaer_z(end) / design_base_shear_z(1))]);
