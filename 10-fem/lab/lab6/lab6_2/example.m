...
node_coordinates = [0 -10; 0 0; 0 10; 10 -10; 10 0; 10 10; 20 -10; 20 0; 20 10; 30 -10; 30 0; 30 10; 40 -10; 40 0; 40 10; 50 -10; 50 0; 50 10; 60 -10; 60 0; 60 10];
...
displacement_reshape = reshape(displacements, 6, []).';
...
figure;
plot([0 10 20 30 40 50 60], displacement_reshape(:, 4), 'b-o', x, uy, 'r');
grid on;
xlabel('x(mm)');
