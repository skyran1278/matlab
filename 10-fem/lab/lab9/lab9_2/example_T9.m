...
Q9_R = plot(node_coordinates(12:22,1),displacements(24:2:44),'bo');
hold on
...
Q9_IR = plot(node_coordinates(12:22,1),displacements(24:2:44),'rs');
hold on
...
% calculation of the system stiffness matrix
stiffness = form_stiffness_2D_Q8(G_dof, number_elements, element_nodes, node_coordinates, D, thickness);


% solution
displacements = solution(G_dof, prescribed_dof, stiffness, force, displacements);

Q8_R = plot(node_coordinates(12:17,1),displacements(24:2:34),'k^');
hold on
...
Q8_IR = plot(node_coordinates(12:17,1),displacements(24:2:34),'k^');
hold on

%exact
x = 0:0.01:5;
exact = -600*x.^2/(2*E*1/12*1*0.5^3);
EXACT = plot(x,exact,'k-');
hold on
xlabel('x')
ylabel('displacement')
