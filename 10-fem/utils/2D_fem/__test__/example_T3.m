...
drawing_deform(nodeCoordinates, element_nodes, displacements, magnification_factor);
...
output_stress(number_elements, element_nodes, nodeCoordinates, D, displacements)
