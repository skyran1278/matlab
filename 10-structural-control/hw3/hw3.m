...
for period_index = 1 : periods_length
    ...
    for filename_index = 1 : filename_length
        ...
        [~, ~, a] = newmark_beta(ag, time_interval, damping_ratio_5_percent, tn, 'average');
...
for damping_index = 1 : damping_ratios_length
    ...
    for period_index = 1 : periods_length
        ...
        for filename_index = 1 : filename_length
            ...
            [~, ~, a] = newmark_beta(ag, time_interval, damping_ratio, tn, 'average');
    ...
    figure(damping_index);
    plot(periods.' * ones(1, filename_length), sa ./ sa_5_percent, 'o');
